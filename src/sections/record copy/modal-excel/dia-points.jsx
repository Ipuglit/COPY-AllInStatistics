            ...
            <Grid item xs={12} sm={12} md={12} sx={{marginTop:'-12px'}}>
                {
                    ...
                    ?
                    <>
                <Chip label={"Total Points: "+data?.POINTS_TOTAL} color="primary" variant="outlined" sx={Cs.BoxChippy('outlinedgray',onMobile ? '10' : '12')}/> &nbsp;
                ...
                <Chip label={"Loss: "+data?.POINTS_LOSS} color="default" variant="outlined" size='small' sx={Cs.BoxChippy('outlinedgray',onMobile ? '9' : '11')}/>
                    ...
                    :
                    <Chip label={"Total Bonus: "+data?.BONUS_TOTAL} color="primary" variant="outlined" sx={Cs.BoxChippy('outlinedgray',onMobile ? '10' : '12')}/>
                }
                    ...
                    {arrayGames.map((i) => (
                        <TableRow key={i.title}>
                            ...
                            <TextField  required
                                            ...
                                            onBlur={(e)=>handleBlur(Fnc.numberNoTrailing(e.currentTarget.value),i.edit)}
