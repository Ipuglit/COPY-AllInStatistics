...
export default function Account({ onClose, onData, onItems, onReturn }) {
    ...
    const listDDown   = onItems.ACCOUNTS.data
    ...
    const newListPlayers  = seeACCOUNTS.filter((e)=> e.value != gotAPP(itemx.UPLINEAPPID,itemx.UPLINEID) && e.value != gotAPP(itemx.AGENCYAPPID,itemx.AGENCYID) && e.value != gotAPP(itemx.DOWNLINEAPPID,itemx.DOWNLINEID) && itemx.APPID == e.appID)
    const newListUplines  = seeACCOUNTS.filter((e)=> e.value != gotAPP(itemx.PLAYERAPPID,itemx.PLAYERID) && e.value != gotAPP(itemx.AGENCYAPPID,itemx.AGENCYID) && e.value != gotAPP(itemx.DOWNLINEAPPID,itemx.DOWNLINEID) && itemx.APPID == e.appID)   
    const newListAgency   = seeACCOUNTS.filter((e)=> e.value != gotAPP(itemx.UPLINEAPPID,itemx.UPLINEID) && e.value != gotAPP(itemx.PLAYERAPPID,itemx.PLAYERID) && e.value != gotAPP(itemx.DOWNLINEAPPID,itemx.DOWNLINEID) && itemx.APPID == e.appID)   
    const newListDownline = seeACCOUNTS.filter((e)=> e.value != gotAPP(itemx.UPLINEAPPID,itemx.UPLINEID) && e.value != gotAPP(itemx.AGENCYAPPID,itemx.AGENCYID) && e.value != gotAPP(itemx.PLAYERAPPID,itemx.PLAYERID) && itemx.APPID == e.appID)   
