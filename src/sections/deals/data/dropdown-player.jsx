...
export default function DDownPlayer({ DATA, RETURN}) {
    ...
    const seeARRAYS = DATA.data.map( (e, index)=> { 
                                                          return {  id:                   e.id,  
                                                                    ...
                                                                    playerNick:           e.userFirstname ? e.userFirstname+' '+e.userLastname : e.userNickname ? e.userNickname : e.accountNickname, 
                                                                  } 
                                                      } 
                                        )
  ...
  return (
                  ...
                  <Autocomplete
                      ...
                      getOptionLabel={(option) => option.value ? option.value : 'All players'}
                      isOptionEqualToValue={(option, value) => value.playerID === selected.playerID}
                      ...
                      renderInput={(params) => (
                        <TextField
                          {...params}
                          label={ selected ? 'Player: '+selected.label : "Filter by player"}
                          variant="outlined"
                          fullWidth
                          sx={{ 
