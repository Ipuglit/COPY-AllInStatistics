...
export default function Formula({ onClose, onData, onItems, onReturn }) {
    ...
    useEffect(() => {
        ...
        setoverAgencyActionValue(itemx?.OVERRIDE_AGENCYACTIONVALUE)
        setoverAgencyBonusValue(itemx?.OVERRIDE_AGENCYBONUSVALUE)
  ...
  return (
            ...
            <Grid item xs={9} sm={9} md={9}>
               ...
               <Grid item xs={12} sm={12} md={12} sx={{marginTop:'-5px'}}>
                ...
                <TextField  
                        ...
                        fullWidth variant="outlined"
                        onChange={(e)=>onSwitch == 'AGENCYBONUS' ? setoverAgencyBonusValue(Fnc.numberDecNegatives(e.currentTarget.value)) : setoverAgencyActionValue(Fnc.numberDecNegatives(e.currentTarget.value))}
                        onBlur={(e)=>onSwitch == 'AGENCYBONUS' ? setoverAgencyBonusValue(Fnc.NumForce(e.currentTarget.value)) : setoverAgencyActionValue(Fnc.NumForce(e.currentTarget.value))}
                        sx={{...Cs.TextCenter,
                            marginBottom:'10px',
                            '& .MuiInputBase-input': { fontSize: onMobile ? '10px' : '12px' }, 
                            '& .MuiInputLabel-root': { fontSize: onMobile ? '11px' : '12px'   }, 
    ...
    <DialogActions style={{paddingBottom:'30px',padding:'30px',display: 'flex', justifyContent: 'center', marginTop:'-30px'}}>
            ...
            <Button variant='standard' onClick={onClose} sx={{borderRadius:'0',width:'50%'}}>CANCEL</Button>
