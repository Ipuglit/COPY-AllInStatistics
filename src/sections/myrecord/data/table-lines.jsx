...
export default function Table_Lines({DATA,FILTER}) {
              ...
              .map((i, index) => (
                <TableRow key={index} hover tabIndex={-1} sx={{'&:hover': { backgroundImage: 'linear-gradient(to top, rgba(148,0,211,.4), rgba(0,0,0,0))' } }}>
                  ...
                  <TableCell style={{fontSize:'11px', minWidth:'140px'}}>
                    ...
                    {
                      i?.line_uplineID != 'None' &&
                      <>
                        <p style={{fontSize:'10px', marginBottom:'-13px', color:'gray'}}>
                          UPLINE
                        </p>
                        <p>ID: {i?.line_uplineID}</p>
                        <p style={{fontSize:'10px', marginTop:'-13px', color:'gray'}}>
                          {i?.uplineNick}
                        </p>
                      </>
                    }
                    ...
                    {
                      i?.line_agencyID != 'None' &&
                      <>
                        <p style={{fontSize:'10px', marginBottom:'-13px', color:'gray'}}>
                          AGENCY
                        </p>
                        <p>ID: {i?.line_agencyID}</p>
                        <p style={{fontSize:'10px', marginTop:'-13px', color:'gray'}}>
                          {i?.agencyNick}
                        </p>
                      </>
                    ...
                    {
                      i?.line_downlineID != 'None' &&
                      <>
                        <p style={{fontSize:'10px', marginBottom:'-13px', color:'gray'}}>
                          DOWNLINE
                        </p>
                        <p>ID: {i?.line_downlineID}</p>
                        <p style={{fontSize:'10px', marginTop:'-13px', color:'gray'}}>
                          {i?.downlineNick}
                        </p>
                      </>
